...
# Load the dataset
df = pd.read_excel("data/cleaned_data.csv") 
...
# set average margin and a retention rate
avg_margin = 0.3  
retention_rate = 0.5  
...
# ---------------------
# Section 4: Cross-Sell Prediction Model (Collaborative Filtering)
...
print("4. Cross-Sell Prediction: Recommended products for cross-selling using Collaborative Filtering (SVD).")
